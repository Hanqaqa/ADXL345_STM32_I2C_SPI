...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  //__HAL_TIM_SET_COMPARE(&htim12, TIM_CHANNEL_1, (uint32_t)(adxl345.acc_msp2[0]*20000) );

	  //sprintf(msgZ, "%.2f", dataZNorm);
	  //HAL_UART_Transmit(&huart3, (uint8_t *)msgZ, strlen(msgZ), HAL_MAX_DELAY);
